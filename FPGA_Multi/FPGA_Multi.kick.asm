...
QT_WRITTEN_BY:
        ...
        .text   "WRITTEN BY RICHARD W. WEILAND."
        .byte   CR,LF,0
QT_MEMORY_SIZE:
        .text   "MEMORY SIZE"
        .byte   0
...
QT_BYTES_FREE:
        .text   " BYTES FREE"
        .byte   CR,LF,CR,LF
        .text   "OSI 6502 BASIC VERSION 1.0 REV 3.2"
        .byte   CR,LF
        .text   "COPYRIGHT 1977 BY MICROSOFT CO."
        .byte   CR,LF,0
